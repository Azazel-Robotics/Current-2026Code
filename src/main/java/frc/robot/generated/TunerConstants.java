...
public class TunerConstants {
    ...
    public static final CANBus kCANBus = new CANBus("2026 CANivore", "./logs/example.hoot");

    // Theoretical free speed (m/s) at 12 V applied output;
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.12);

    // Every 1 rotation of the azimuth (steering motor) results in kCoupleRatio drive motor turns;
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.154541015625);
